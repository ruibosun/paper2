...
ggplot(year_range, aes(x = Month, y = as.numeric(Ridership)/1000)) +
  geom_line(color = "blue") +
  labs(title = "Subway Ridership in Santo Domingo, Dominican Republic",
       x = "Month", y = "Ridership",
       subtitle = "February 2000 - December 2010") +
  theme_minimal() +
  theme(plot.caption = element_text(size = 10))
